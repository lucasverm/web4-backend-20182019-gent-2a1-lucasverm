...
namespace BijenkastApi.Data
{
    public class BijenkastDatainitializer
    {
        ...
        public async Task InitializeData()
        {
            ...
            {
                Bijenkast b = new Bijenkast("kast in de tuin", "dadant", 1, 1, 10, "buckfast", 26, 5, 1998, true, false, true, 6, 3, 2014, new List<Inspectie>());
                ...
                b = new Bijenkast("kast bij de buren", "simplex", 2, 1, 10, "buckfast", 6, 8, 2017, true, false, true, 3, 4, 2019, new List<Inspectie>());
